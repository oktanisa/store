			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading">
						<h2><span>MAINAN ANAK</span></h2>
						<p>Kategori mainan anak yang pastinya akan menghibur anak anda dengan harga terjamin. Menyediakan Topi, kerudung, atasan, bawahan, hingga sepatu. ada untuk pria / wanita.</p>
					</div>
				</div>
				<div class="row">
