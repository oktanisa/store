  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	...
			   	<li style="background-image: url(images/fashiontas.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			
			   		</div>
			   	</li>
			   	<li style="background-image: url(images/tasbayi.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading">
						<h2><span>ABAGBAG.COM</span></h2>
						<p>Toko online termurah dan terlengkap di Jember. Menyediakan berbagai kebutuhan fashion, perlengkapan bayi, mainan anak serta peralatan rumah tangga.</p>
					</div>
				</div>
		...
		<div class="colorlib-shop">
			<div class="container">
				<div class="row">
					<div class="col-md-15 col-md-push-8">
						<div class="row row-pb-lg">
							<div class="col-md-6 text-center">
								<div class="product-entry">
									...
									<div class="desc">
										<h3><a href="product-detail.html">Kategori</a></h3>
										<p class="price"><span>Fashion</span></p>
									</div>
								</div>
							</div>
							<div class="col-md-6 text-center">
								<div class="product-entry">
									...
									<div class="desc">
										<h3><a href="product-detail.html">Kategori</a></h3>
										<p class="price"><span>Bayi</span></p>
									</div>
								</div>
							</div>
							<div class="col-md-6 text-center">
								<div class="product-entry">
									...
									<div class="desc">
										<h3><a href="product-detail.html">Kategori</a></h3>
										<p class="price"><span>Mainan Anak</span></p>
									</div>
								</div>
							</div>
							<div class="col-md-6 text-center">
								<div class="product-entry">
									...
									<div class="desc">
										<h3><a href="product-detail.html">Kategori</a></h3>
										<p class="price"><span>Peralatan Rumah Tangga</span></p>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="colorlib-shop">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading">
						<h2><span>DISKON</span></h2>
						<p>Belanja hemat dengan info harga promo yang diupdate setiap harinya.</p>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-3 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(images/bayi1.jpg);">
								<p class="tag"><span class="new">Diskon</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="cart.html"><i class="icon-shopping-cart"></i></a></span> 
							...
							<div class="desc">
								...
								<p class="price"><span>Rp 39.000</span> <span class="sale">Rp 165.000</span> </p>
							</div>
						</div>
					</div>
					<div class="col-md-3 text-center">
						<div class="product-entry">
							...
							<div class="desc">
								<h3><a href="shop.html">KERETA BAYI</a></h3>
					...
					<div class="col-md-3 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(images/mainan2.jpg);">
								<p class="tag"><span class="new">Diskon</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="cart.html"><i class="icon-shopping-cart"></i></a></span> 
					...
					<div class="col-md-3 text-center">
						<div class="product-entry">
							...
							<div class="desc">
								<h3><a href="shop.html">MOBIL MOBILAN</a></h3>
					...
					<div class="col-md-3 text-center">
						<div class="product-entry">
							...
							<div class="desc">
								<h3><a href="shop.html">TEKO MASPION</a></h3>
					...
					<div class="col-md-3 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(images/rt2.jpg);">
								<p class="tag"><span class="new">Diskon</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="cart.html"><i class="icon-shopping-cart"></i></a></span> 
							...
							<div class="desc">
								<h3><a href="shop.html">SENDOK SET WESTON</a></h3>
